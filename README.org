...
- [[#programming-languages][Programming languages]]
  - [[#treesit-grammar][Treesit grammar]]
...
** Treesit grammar
Function used to register a grammar to be used by treesitter based modes
#+begin_src emacs-lisp
  (defun cfg/install-tree-grammar (lang grammar-config)
    (add-to-list 'treesit-language-source-alist `(,lang . ,grammar-config))
...
Configure typescript using treesitter
#+begin_src emacs-lisp
  (use-package typescript-ts-mode
    ...
    :preface
    (cfg/install-tree-grammar 'javascript '("https://github.com/tree-sitter/tree-sitter-javascript"))
    (cfg/install-tree-grammar 'typescript '("https://github.com/tree-sitter/tree-sitter-typescript" "v0.23.2" "typescript/src")))
#+end_src
...
#+begin_src emacs-lisp
  (use-package toml-ts-mode
    ...
    :preface
    (cfg/install-tree-grammar 'toml '("https://github.com/tree-sitter/tree-sitter-toml")))
#+end_src
*** YAML mode
#+begin_src emacs-lisp
  (use-package yaml-ts-mode
    ...
    :preface
    (cfg/install-tree-grammar 'yaml '("https://github.com/tree-sitter-grammars/tree-sitter-yaml")))
#+end_src
*** JSON mode
#+begin_src emacs-lisp
  (use-package json-ts-mode
    :mode ((rx ".json" string-end) . json-ts-mode)
    :preface
    (cfg/install-tree-grammar 'json '("https://github.com/tree-sitter/tree-sitter-json"))
