...
#+begin_src emacs-lisp
  (defun cfg/install-tree-grammar (lang grammar-config)
    (add-to-list 'treesit-install-language-grammar (lang . grammar-config))
...
#+begin_src emacs-lisp
  (use-package toml-ts-mode
    ...
    :config (cfg/install-tree-grammar "toml" '("https://github.com/tree-sitter/tree-sitter-toml")))
#+end_src
*** YAML mode
#+begin_src emacs-lisp
  (use-package yaml-ts-mode
    :mode ((rx ".yaml" string-end) . yaml-ts-mode)
    :config (cfg/install-tree-grammar "yaml" '("https://github.com/tree-sitter-grammars/tree-sitter-yaml")))
#+end_src
*** JSON mode
#+begin_src emacs-lisp
  (use-package json-ts-mode
    :mode ((rx ".json" string-end) . json-ts-mode)
    :config (cfg/install-tree-grammar "json" '("https://github.com/tree-sitter/tree-sitter-json")))
#+end_src
